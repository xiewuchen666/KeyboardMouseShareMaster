...
set(CPACK_PACKAGE_NAME "${CMAKE_PROJECT_DISPLAY_NAME}")

# Menu Entry
set(CPACK_WIX_PROGRAM_MENU_FOLDER "${CMAKE_PROJECT_DISPLAY_NAME}")
set(CPACK_PACKAGE_EXECUTABLES "deskflow" "${CMAKE_PROJECT_DISPLAY_NAME}")

# Default Install Path
set(CPACK_PACKAGE_INSTALL_DIRECTORY "${CMAKE_PROJECT_DISPLAY_NAME}")

# Wix Specific Values
set(CPACK_WIX_UPGRADE_GUID "805C136E-2ADA-40B9-8A89-009C0CC863B9")
set(CPACK_WIX_PRODUCT_ICON "${CMAKE_SOURCE_DIR}/src/apps/res/deskflow.ico")
